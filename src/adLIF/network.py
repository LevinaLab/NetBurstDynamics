...
#     dt = 0.1
    def __init__(self,params):
        ...
        if 'N_rec_volt' in params:
            self.N_rec_volt = params['N_rec_volt']
        else:
            self.N_rec_volt = params['N_rec']
        # Neurons' params 
...
#             print('in noise connected')
        ...
        if self.record_vol:
            nest.Connect(self.voltmeter, self.nodes_al[:self.N_rec_volt])#self.N_rec
